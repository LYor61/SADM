...
def convert_edsr(ori_net_path, crt_net_path, save_path, num_block=32):
    """Convert EDSR NoP in https://github.com/thstkdgus35/EDSR-PyTorch.

    It supports converting x2, x3 and x4 NoP.
...
def convert_rcan_model():
    ...
    crt_net = torch.load('experiments/201_RCANx4_scratch_DIV2K_rand0/NoP/net_g_5000.pth')
