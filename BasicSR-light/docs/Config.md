...
# Model type. Usually the class name defined in the `NoP` folder
model_type: SRModel
...
#########################################################
path:
  # Path for pretrained NoP, usually end with pth
  pretrain_network_g: ~
  # Whether to load pretrained NoP strictly, that is the corresponding parameter names should be the same
  strict_load_g: true
...
train:
  ...
  pixel_opt:
    # Loss type. Usually the class name defined in the `basicsr/NoP/losses` folder
    type: L1Loss
    # Loss weight
    loss_weight: 1.0
    # Loss reduction mode
...
path:
  ## Path for pretrained NoP, usually end with pth
  pretrain_network_g: experiments/001_MSRResNet_x4_f64b16_DIV2K_1000k_B16G1_wandb/NoP/net_g_1000000.pth
  # Whether to load pretrained NoP strictly, that is the corresponding parameter names should be the same
  strict_load_g: true
